...
(function () {
  ...
  window.I18N = {
    ru: {
      ...
      menuConcentration: "Концентрация",
      menuConcSets: "Сеты",
      menuConcContext: "Контекст",
      menuTrainingMode: "Режим тренировки",
      menuTranslation: "Перевод",
      menuForward: "Прямой",
      menuReverse: "Обратный",
      menuSetProgress: "Переход по сетам",
      menuManual: "Ручной",
      menuAuto: "Авто",
      menuTheme: "Тема",
    ...
    uk: {
      ...
      menuConcentration: "Концентрація",
      menuConcSets: "Сети",
      menuConcContext: "Контекст",
      menuTrainingMode: "Режим тренування",
      menuTranslation: "Переклад",
      menuForward: "Прямий",
      menuReverse: "Зворотний",
      menuSetProgress: "Перехід по сетах",
      menuManual: "Ручний",
      menuAuto: "Авто",
      menuTheme: "Тема",
