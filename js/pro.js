...
(function(root){
  ...
  function t(){
    ...
    return uk ? {
      ...
      cardDesc: 'Найближчим часом ми додамо оплату банківськими картами напряму.',
      ...
      cardDesc: 'В ближайшее время мы добавим оплату банковскими картами напрямую.',
  ...
  function initPaypalButtons(){
    ...
    var container = sheet && sheet.querySelector('#paypal-button-container');
    if (!container) {
    ...
    root.paypal.Buttons({
      createOrder: function (data, actions) {
        return actions.order.create({
          purchase_units: [{
            amount: { value: '5.00' } // цена PRO (sandbox / потом live)
          }]
        });
      },
  ...
  function open(){
    ...
    var html = ''
      ...
      // страница 1 — карта (пока заглушка)
