...
window.decks.de_verbs_lernpunkt = [
  ...
  { id: 6, word: "hören", ru: "слушать", uk: "слухати", level: "A1", topics: ["communication"], deSynonyms: [], ruSynonyms: [], ukSynonyms: [], deAntonyms: [], ruAntonyms: [], ukAntonyms: [], examples: [{ L2: "Ich höre Musik.", ru: "Я слушаю музыку.", uk: "Я слухаю музику." }] },
